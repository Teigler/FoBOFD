...
namespace System.Windows.Controls
{
	...
	/// Teigler: 
	///		<para>
	///		 The <see cref="MultiSelectTreeView"/> class and component was not included via Nuget, 
	///		 because this component still has some problems.
	///		 E.g. there are exceptions from time to time.
	///		 Therefore this component was copied directly into the codebase.
	///		</para>
	///		<para>
	///		Todo: Cleanup and refactor the <see cref="MultiSelectTreeView"/> classes.
	///		</para>
	/// </summary>
